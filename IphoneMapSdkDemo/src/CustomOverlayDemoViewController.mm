...
//        self.edgesForExtendedLayout=UIRectEdgeNone;
    ...
    BMKMapPoint * testPoint = new BMKMapPoint[1];
    testPoint[0].x = pt1.x;
    testPoint[0].y = pt1.y;
    CustomOverlay* testOverlayer = [[CustomOverlay alloc] initWithPoints:testPoint count:1];
    [_mapView addOverlay:testOverlayer];
